...
**[Download OpenAirCast v0.1.0](https://github.com/TTK95/OpenAirCast/releases/tag/v0.1.0)**
— the first public portable release. The Windows ZIP, matching source archive
and SHA-256 checksums are available under Assets. Public downloads were verified
on 2026-09-10. See the known limitations below before using it.

1. Open [the v0.1.0 release](https://github.com/TTK95/OpenAirCast/releases/tag/v0.1.0).
...
4. Run `OpenAirCast.exe` from the extracted folder. Administrator mode is not
   normally required. The v0.1.0 executable is unsigned.
