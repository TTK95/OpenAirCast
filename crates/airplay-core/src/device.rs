...
///
/// Ordering is the lexicographic order of the MAC bytes. It carries no
/// meaning of its own — it exists so the identifier can key an ordered map
/// (e.g. a calibration profile) with a deterministic iteration order.
