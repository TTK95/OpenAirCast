...
Published and publicly verified on 2026-09-10:
[OpenAirCast v0.1.0](https://github.com/TTK95/OpenAirCast/releases/tag/v0.1.0).
The regular release contains the Windows x64 portable ZIP, matching source ZIP
and SHA256SUMS.txt. All three anonymous downloads matched the staged hashes.
Source revision: `dafc765c3234f7a4b4177a2cbf9494d45c4cec9a`.
The executable is unsigned and the known Suspend/Cancel bug is disclosed.
See [Status](STATUS.md) for verification limits and remaining work.
